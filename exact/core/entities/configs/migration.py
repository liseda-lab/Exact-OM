...
V1_TO_V2: Dict[str, MigrationTarget] = {
    ...
    "candidates_params.adaptive_k": "candidates.adaptive_k",
    "candidates_params.encoder_finetune": "candidates.encoder_finetune",
    "candidates_params.cross_encoder": "candidates.cross_encoder",
    "candidates_params.multi_view": "candidates.multi_view",
