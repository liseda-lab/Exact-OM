...
class StaticPrompts:
    ...
    CONFIDENCE = {
        ...
        Likelihood.int: f"Followed by your confidence in your answer as a score from 0 to 10, like this: '{POSITIVE_SOLUTION}:8'",
        Likelihood.cat: f"Followed by your confidence in your answer 'not confident', 'confident', 'very confident', like this: '{POSITIVE_SOLUTION}:confident'"
    }
    CRITIC_SKELETON = f"You are verifying an ontology aligmnent task, given the question $P the response was $R is this correct? You should answer '{POSITIVE_SOLUTION}' or '{NEGATIVE_SOLUTION}'."
