...
**Design revision: 2026-09-10 (E04 benchmark-NIL scope). G0 passed; E05/E26/E06 screens retained their controls. All six E02 cells and final reports completed on 2026-09-20; E02 retained the hard-anchor baseline. The reporting repair reused every scientific output and made zero new model calls. D1 SNOMED preparation completed. FMA reification repair passed its XML structural audit; the target-only native probe is running in Slurm step 14234.14. Full E09 remains blocked on native and production hierarchy/resource qualification. The main `.venv` now uses the four published PyPI 0.2.1 native packages.**
