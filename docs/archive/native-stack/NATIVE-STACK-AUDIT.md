...
[Measurement details](https://github.com/liseda-lab/Exact-OM/blob/main/specs/experiments/NATIVE-PREPROCESSING.md) preserve input and output identities.
...
unseparated. Sources: [Exact annotation cache](https://github.com/liseda-lab/Exact-OM/blob/main/exact/ontology/store.py#L473),
